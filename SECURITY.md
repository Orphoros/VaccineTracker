...
The Vaccine Tracker webapp is currently in development and not yet ready for production use. It is a proof of concept in its current state to test Ruby on Rails as a framework for building the application.
...
Currently, due to the early stage of development, only the latest version of the Vaccine Tracker webapp is supported with security updates.
